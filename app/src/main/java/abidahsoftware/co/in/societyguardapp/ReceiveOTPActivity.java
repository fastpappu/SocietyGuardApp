...
public class ReceiveOTPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receive_otpactivity);
                    ...
                    FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential)
                            .addOnCompleteListener(task -> {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(ReceiveOTPActivity.this, "OTP Invalid", Toast.LENGTH_SHORT).show();
                                }
                            });
                } else {
                    Toast.makeText(ReceiveOTPActivity.this, "please check internet connection", Toast.LENGTH_SHORT).show();
                }
                Toast.makeText(ReceiveOTPActivity.this, "successfully verified", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(ReceiveOTPActivity.this, "OTP can not be Blank", Toast.LENGTH_SHORT).show();
            }
        });
        numberOtpMove();
